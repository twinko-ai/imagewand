        ...
        with Image.open(image_path) as img:
            ...
            try:
                ...
                if dpi:
                    ...
                    if exif and 282 in exif and 283 in exif:  # XResolution and YResolution
                        info["dpi_x"] = exif[282]
                        info["dpi_y"] = exif[283]
                    else:
                        info["dpi_x"] = "Unknown"
...
def print_image_info(image_path: str, verbose: bool = False) -> None:
    ...
    try:
        ...
        if 'brightness_mean' in info:
            ...
            if 'red_mean' in info:
                print("\nColor Channels:")
                print(f"  Red: min={info['red_min']}, max={info['red_max']}, avg={info['red_mean']}")
                print(f"  Green: min={info['green_min']}, max={info['green_max']}, avg={info['green_mean']}")
                print(f"  Blue: min={info['blue_min']}, max={info['blue_max']}, avg={info['blue_mean']}")
